...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//it can access the variable internal because it is within the block scope. 
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(animals){
    ...
    let animalFulName = `name: ${name}, scientific: ${scientific}`;
    displayNames.push(animalFulName);
    });
   return displayNames;
  }
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    return zooAnimals.filter((animals)=> {
      let lowPop = animals.population < 5;
      return lowPop;
    });
  }
  ...
  */
  ...
  function USApop(zooAnimals){
    return zooAnimals.reduce((totalSum, animal) =>{
      let sum = totalSum + animal.population;
      return sum;
    }, 0);
